...
from app.auth import LoginRequest, create_session_token, verify_login
...
def test_login_verification_and_session_expiry() -> None:
    ...
    payload = jwt.decode(create_session_token("admin", config), config.admin_session_secret, algorithms=["HS256"])
